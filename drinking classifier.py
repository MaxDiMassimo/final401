...
dataset = pd.read_csv('final project - drinking ready.csv')
...
smoking = input("1/19 : do you smoke? \nNever = 0, Tried = 1, Current smoker = 2, Former smoker = 3\n")
...
if entered_prediction == 0:
    print("Answer: You never drink.")
if entered_prediction == 1:
    print("Answer: You drink socially.")
if entered_prediction == 2:
    print("Answer: You drink a lot.")